 ...
 @section('content')
                 ...
                 <div class="hero-slider-item">
                     <div class="row">
                         <div class="col-md-8">
                             ...
                             <a href="{{ route('contact') }}" class="btn btn-primary" data-animation-out="fadeOutRight"
     ...
     <section class="section pt-2">
         <div class="container">
             <div class="row">
                 <div class="col-12">
                     <form id="filterForm" method="GET" action="{{ route('site.teachers') }}">
                         <div class="d-flex justify-content-end mb-3">
                             <select name="category_name" class="form-select p-2" aria-label="Select Category"
                                 id="categoryFilter">
